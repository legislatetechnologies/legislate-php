...
/**
 * UpdateFieldsCollaboratorDTO Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateFieldsCollaboratorDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateFieldsCollaboratorDTO';
...
self::ROLES_WITNESS,        ];
     ...
     * Sets roles
     *
     * @param string[] $roles The new role of the collaborator.
     *
     * @return $this
     */
